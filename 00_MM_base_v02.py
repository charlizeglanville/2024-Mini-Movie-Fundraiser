...
def show_instructions():
    ...
    ***** Instructions *****
    ...
    When you have entered all the users, press 'xx' to quit.
...
while tickets_sold < MAX_TICKETS:
    ...
    # exit loop if users type 'xx' and have sold at least one ticket
    if name == 'xx' and len(all_names) > 0:
        break
    elif name == 'xx':
